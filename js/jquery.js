...
jQuery.each( [ "hauteur", "largeur" ​​], function( _i, dimension ) {
	jQuery.cssHooks[ dimension ] = {
		...
		set : function( élément, valeur, extra ) {
			...
			if ( soustraire && ( matches = rcssNum.exec( valeur ) ) &&
	...
	ajax: fonction (URL, options) {
		...
		transports varois,
			...
			jqXHR = {
				...
				// Annuler la requête
				abandonner : function( statusText ) {
		...
		jQuery.fn[ funcName ] = fonction( marge, valeur ) {
			...
			return access( this, function( elem, type, value ) {
				...
				si ( elem.nodeType === 9 ) {
					...
					// Soit scroll[Width/Height] ou offset[Width/Height] ou client[Width/Height],
