...
$(document).ready(function () {
    ...
    $('#trigger').click( function () {
        $("#creation_agence").attr("style","display:block;");
      })

      $('#close').click( function () {
        $("#creation_agence").attr("style","display:none;");
      })
    ...
    $.ajax({
        //L'URL de la requête 
        url: "https://api.app-qhse.fr/v2/agencies",
        ...
        .done(function (response) {
            ...
            $.each(response.data, function (index, value) {
                ...
                $('#agencenom').append("<tr><td class='styleTd'>" + value.name + "</td></tr>")
                $('#agencecode').append("<tr><td class='styleTd'>" + value.agency_region_code + "</td></tr>")
                $('#agencezone').append("<tr><td class='styleTd'>" + value.operationArea + "</td></tr>")
                $('#agenceregion').append("<tr><td class='styleTd'>" + value.name + "</td></tr>")
